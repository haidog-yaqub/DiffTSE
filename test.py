...
if __name__ == "__main__":
    ...
    train_set = TSEDataset(data_dir='../data/fsd2018/', subset='train', length=4,
                           use_timbre_feature=True, timbre_path='../data/fsd2018/timbre_mae')
    test = train_set[666]
    mixture, timbre, target, onset, offset, cls, timbre_feature, event = test
    ...
    #
    # a = (a.cpu().numpy())
    sf.write('mixture.wav', mixture[0], samplerate=16000)
    sf.write('target.wav', target[0], samplerate=16000)
    sf.write('timbre.wav', timbre[0], samplerate=16000)
